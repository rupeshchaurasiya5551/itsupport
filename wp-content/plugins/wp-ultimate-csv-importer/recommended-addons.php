...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
   ...
   <div class="import_1">
     <h2>Import Users</h2>
        ...
        <div class="col-4">
        <?php if(is_plugin_active('import-users/import-users.php') && is_plugin_active('import-users/import-users.php')){
                  print'<button name="get" data-value="Users" id="btn_install_act" disabled="disabled">Activated</button>';}
             else{print '<button name="get" data-value="Users" id="btn_install">Install</button>';}
       ?>
        </div>
   ...
   <div class="import_2">
     <h2>Import Woocommerce</h2>
        ...
        <div class="col-4">
        <?php if(is_plugin_active('import-woocommerce/import-woocommerce.php') && is_plugin_active('import-woocommerce/import-woocommerce.php')){
                print '<button name="get"data-value="WooCommerce" id="btn_install_act" disabled="disabled">Activated</button>';}
             else{print '<button name="get"data-value="WooCommerce" id="btn_install">Install</button>';}?>
        </div>
   ...
   <div class="import_3">
     <h2>Export Wordpress Data</h2>
        ...
        <div class="col-4">
        <?php if(is_plugin_active('wp-ultimate-exporter/wp-ultimate-exporter.php') && is_plugin_active('wp-ultimate-exporter/wp-ultimate-exporter.php')){
                 print '<button name="get"data-value="Exporter" id="btn_install_act" class="btn_g" disabled="disabled" >Activated</button>';}
              else{print '<button name="get"data-value="Exporter" id="btn_install" class="btn_g">Install</button>';}?>
        </div>
   ...
   <div input type="button" class="buttonmid" id="click_get_started">
        <?php echo esc_html__('All Install & Activate','wp-ultimate-csv-importer');?>
